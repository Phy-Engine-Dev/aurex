...
from aurex.tools.web_search import web_search, web_fetch, fetch_public_bytes, _public_endpoint
...
class SearchProviderTests(unittest.TestCase):
    def test_brave_uses_real_auth_header_and_json_results(self):
        response = mock.Mock()
        response.json.return_value = {"web": {"results": [{"title": "TI", "url": "https://ti.com/a", "description": "datasheet"}]}}
    ...
    def test_searxng_json_configured_endpoint(self):
        response = mock.Mock()
        response.json.return_value = {"results": [{"title": "source", "url": "https://example.org", "content": "text"}]}
