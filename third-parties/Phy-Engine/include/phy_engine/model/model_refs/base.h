    ...
    namespace details
    {
        ...
        struct model_derv_impl final : model_base_impl
        {
                                   ...
                                   ::phy_engine::model::digital_update_method_t method) noexcept override
            {
                ...
                {
                    auto result{update_digital_clk_define(
                        ::phy_engine::model::model_reserve_type<rcvmod_type>,
                        m, table, tr_duration, method)};
                    if(result.need_to_operate_analog_node) { result.driver = this; }
                    return result;
                }
                else
                {
