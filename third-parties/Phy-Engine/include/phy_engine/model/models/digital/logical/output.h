...
namespace phy_engine::model
{
        ...
        set_attribute_define(::phy_engine::model::model_reserve_type_t<OUTPUT>, OUTPUT& clip, ::std::size_t n, ::phy_engine::model::variant vi) noexcept
    {
        ...
        switch(n)
        {
            ...
            case 3: if(vi.d < 0.0) return false; clip.Tsu = vi.d; return true;
            case 4: if(vi.d < 0.0) return false; clip.Th = vi.d; return true;
        ...
        get_attribute_define(::phy_engine::model::model_reserve_type_t<OUTPUT>, OUTPUT const& clip, ::std::size_t n) noexcept
    {
        switch(n)
        {
            ...
            case 3: return {.d{clip.Tsu}, .type{::phy_engine::model::variant_type::d}};
            case 4: return {.d{clip.Th}, .type{::phy_engine::model::variant_type::d}};
            default:
            {
                return {};
            }
