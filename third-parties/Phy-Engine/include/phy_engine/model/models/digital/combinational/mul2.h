...
namespace phy_engine::model
{
                                  ...
                                  ::phy_engine::model::digital_update_method_t /*method*/) noexcept
    {
        ...
        // PhysicsLab treats an open multiplier input as a low bit and permits
        // any subset of product bits to be consumed.  Requiring all eight
        // pins to be wired made this common AND/partial-product idiom inert.
        if(p0 || p1 || p2 || p3) [[likely]]
        {
