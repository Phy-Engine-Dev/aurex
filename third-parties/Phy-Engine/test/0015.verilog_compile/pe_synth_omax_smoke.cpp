...
int main()
{
    ...
    // pe_synth uses level 5 for the Omax orchestration layer; level 4 is the
    // single O4 fixpoint and correctly has no Omax report trace.
    auto const omax = run_once(5);
    if(!omax) { return 2; }
